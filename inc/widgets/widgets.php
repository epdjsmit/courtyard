...
require COURTYARD_DIR . '/inc/widgets/services-widget.php';
require COURTYARD_DIR . '/inc/widgets/recent-posts-widget.php';
require COURTYARD_DIR . '/inc/widgets/image-slider-widget.php';
require COURTYARD_DIR . '/inc/widgets/packages-widget.php';
require COURTYARD_DIR . '/inc/widgets/rooms-widget.php';
require COURTYARD_DIR . '/inc/widgets/video-widget.php';
require COURTYARD_DIR . '/inc/widgets/about-widget.php';
require COURTYARD_DIR . '/inc/widgets/social-icon-widget.php';
require COURTYARD_DIR . '/inc/widgets/logo-widget.php';
require COURTYARD_DIR . '/inc/widgets/testimonial-widget.php';
