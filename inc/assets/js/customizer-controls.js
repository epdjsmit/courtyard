...
// Customizer Image Section add Class Name for Design
jQuery(document).ready(function($) {
    $('.controls#pt-img-container li img').click(function(){
        $('.controls#pt-img-container li').each(function(){
            $(this).find('img').removeClass ('pt-radio-img-selected') ;
        });
        $(this).addClass ('pt-radio-img-selected') ;
    });
});
