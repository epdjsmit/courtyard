...
function courtyard_customize_register( $wp_customize ) {
    ...
    // Required Customizer Controls and Sanitize files
    require COURTYARD_DIR . '/inc/customizer/controls.php';
    require COURTYARD_DIR . '/inc/customizer/sanitize.php';
...
/*---------------------------------------- SINGLE POST ----------------------------------------------------------*/
    ...
    $wp_customize->add_control( new WP_Customizer_Image_Radio_Control( $wp_customize, 'courtyard_post_global_sidebar', array(
        ...
        'choices'            => array(
            'right_sidebar'                 => COURTYARD_URI . '/inc/assets/images/right-sidebar.svg',
            'left_sidebar'                  => COURTYARD_URI . '/inc/assets/images/left-sidebar.svg',
            'no_sidebar_full_width'         => COURTYARD_URI . '/inc/assets/images/no-sidebar.svg',
        ),
    ) ) );
...
/*--------------------------------------- FOOTER PANEL -----------------------------------------------------------*/
    ...
    $wp_customize->add_control( new WP_Customizer_Image_Radio_Control( $wp_customize, 'courtyard_footer_widget_area_layout', array(
        ...
        'choices'            => array(
            '1by1'                      => COURTYARD_URI . '/inc/assets/images/no-sidebar.svg',
            '1by2_1by2'                 => COURTYARD_URI . '/inc/assets/images/footer-1by2-1by2.svg',
            '1by3_1by3_1by3'            => COURTYARD_URI . '/inc/assets/images/footer-1by3-1by3-1by3.svg',
            '1by4_1by4_1by4_1by4'       => COURTYARD_URI . '/inc/assets/images/footer-1by4-1by4-1by4-1by4.svg',
        ),
    ) ) );
...
function courtyard_customize_preview_js() {
    wp_enqueue_script('courtyard_customizer', courtyard_asset_url('customizer-preview', 'css', '', 'admin'),array( 'customize-preview' ), COURTYARD_VERSION, true);
}
